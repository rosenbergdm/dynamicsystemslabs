...
\svnidlong
{$HeadURL: svn+ssh://root@apalmerlab1.palmerlab.org/SVN_ROOT/dynamicsystemslabs/meta/Examples/ExampleSweaveListingUtils.Rnw $}
{$LastChangedDate: 2009-10-01 11:08:20 -0500 (Thu, 01 Oct 2009) $}
